      ...
      <main className="main">
        ...
        <div className="info">
          ...
          <p>
            ...
            <span className="lg">
              <a target={'_blank'} href="https://querobolsa.com.br/cursos-e-faculdades/sistemas-para-internet  ">
                SISTEMAS PARA INTERNET.
              </a> 
            </span>&nbsp;
            Além disso, estudo e tenho experiências de projetos pessoais com algumas tecnologias e bibliotecas baseadas em JS, destaco aqui o REACTJS E REACT-NATIVE. 
          </p>
          <Social />
        </div>
      </main>
